...
// ProjectFreezePeriod represents a project freeze period.
//
// GitLab API docs:
...
type ListProjectFreezePeriodsOptions ListOptions

// ListProjectFreezePeriods gets a list of project project freeze periods.
//
// GitLab API docs:
// https://docs.gitlab.com/ce/api/freeze_periods.html#list-freeze-periods
func (s *ProjectsService) ListProjectFreezePeriods(pid interface{}, opt *ListProjectFreezePeriodsOptions, options ...RequestOptionFunc) ([]*ProjectFreezePeriod, *Response, error) {
	project, err := parseID(pid)
	if err != nil {
		return nil, nil, err
	}
...
// GetProjectFreezePeriod gets a specific freeze period for a project.
//
// GitLab API docs:
// https://docs.gitlab.com/ce/api/freeze_periods.html#get-a-freeze-period-by-a-freeze_period_id
func (s *ProjectsService) GetProjectFreezePeriod(pid interface{}, freeze_period int, options ...RequestOptionFunc) (*ProjectFreezePeriod, *Response, error) {
	project, err := parseID(pid)
	if err != nil {
		return nil, nil, err
	}
	u := fmt.Sprintf("projects/%s/freeze_periods/%d", pathEscape(project), freeze_period)
...
// CreateProjectFreezePeriodOptions represents the available CreateProjectFreezePeriod() options.
//
// GitLab API docs:
...
// GitLab API docs:
// https://docs.gitlab.com/ce/api/freeze_periods.html#create-a-freeze-period
func (s *ProjectsService) CreateProjectFreezePeriod(pid interface{}, opt *CreateProjectFreezePeriodOptions, options ...RequestOptionFunc) (*ProjectFreezePeriod, *Response, error) {
	project, err := parseID(pid)
	if err != nil {
		return nil, nil, err
	}
...
// UpdateProjectFreezePeriodOptions represents the available UpdateProjectFreezePeriod() options.
//
// GitLab API docs:
...
// GitLab API docs:
// https://docs.gitlab.com/ce/api/freeze_periods.html#update-a-freeze-period
func (s *ProjectsService) UpdateProjectFreezePeriod(pid interface{}, freeze_period int, opt *UpdateProjectFreezePeriodOptions, options ...RequestOptionFunc) (*ProjectFreezePeriod, *Response, error) {
	project, err := parseID(pid)
	if err != nil {
		return nil, nil, err
	}
...
func (s *ProjectsService) DeleteFreezePeriod(pid interface{}, freeze_period int, options ...RequestOptionFunc) (*Response, error) {
	project, err := parseID(pid)
	if err != nil {
		return nil, err
	}
