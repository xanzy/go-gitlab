...
func (s *CommitsService) GetCommitDiff(pid interface{}, sha string, opt *ListOptions, options ...OptionFunc) ([]*Diff, *Response, error) {
	project, err := parseID(pid)
	if err != nil {
		return nil, nil, err
	}
...
func (s *CommitsService) GetCommitComments(pid interface{}, sha string, opt *ListOptions, options ...OptionFunc) ([]*CommitComment, *Response, error) {
	project, err := parseID(pid)
	if err != nil {
		return nil, nil, err
	}
