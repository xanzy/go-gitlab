...
type Settings struct {
	...
	ArchiveBuildsInHumanReadable              *string           `json:"archive_builds_in_human_readable,omitempty"`
	...
	AuthorizedKeysEnabled                     *bool             `json:"akismet_enabled,omitempty"`
	...
	ContainerRegistryTokenExpireDelay         *int              `json:"container_registry_token_expire_delay,omitempty"`
	...
	DefaultGroupVisibility                    *VisibilityValue  `json:"default_group_visibility,omitempty"`
	DefaultProjectCreation                    *int              `json:"default_project_creation,omitempty"`
	DefaultProjectsLimit                      *int              `json:"default_projects_limit,omitempty"`
	DefaultProjectVisibility                  *VisibilityValue  `json:"default_project_visibility,omitempty"`
	DefaultSnippetVisibility                  *VisibilityValue  `json:"default_snippet_visibility,omitempty"`
	DiffMaxPatchBytes                         *int              `json:"diff_max_patch_bytes,omitempty"`
	...
	DSAKeyRestriction                         *int              `json:"dsa_key_restriction,omitempty"`
	ECDSAKeyRestriction                       *int              `json:"ecdsa_key_restriction,omitempty"`
	Ed25519KeyRestriction                     *int              `json:"ed25519_key_restriction,omitempty"`
	...
	EnforceTerms                              *bool             `json:"enabled_git_access_protocol,omitempty"`
	...
	ExternalAuthorizationServiceTimeout       *float64          `json:"external_authorization_service_timeout,omitempty"`
	...
	GeoStatusTimeout                          *int              `json:"geo_status_timeout,omitempty"`
	GitalyTimeoutDefault                      *int              `json:"gitaly_timeout_default,omitempty"`
	GitalyTimeoutFast                         *int              `json:"gitaly_timeout_fast,omitempty"`
	GitalyTimeoutMedium                       *int              `json:"gitaly_timeout_medium,omitempty"`
	...
	HousekeepingFullRepackPeriod              *int              `json:"housekeeping_full_repack_period,omitempty"`
	HousekeepingGcPeriod                      *int              `json:"housekeeping_gc_period,omitempty"`
	HousekeepingIncrementalRepackPeriod       *int              `json:"housekeeping_incremental_repack_period,omitempty"`
	...
	LocalMarkdownVersion                      *int              `json:"local_markdown_version,omitempty"`
	MaxArtifactsSize                          *int              `json:"max_artifacts_size,omitempty"`
	MaxAttachmentSize                         *int              `json:"max_attachment_size,omitempty"`
	MaxPagesSize                              *int              `json:"max_pages_size,omitempty"`
	MetricsEnabled                            *bool             `json:"metrics_enabled,omitempty"`
	MetricsHost                               *string           `json:"metrics_host,omitempty"`
	MetricsMethodCallThreshold                *int              `json:"metrics_method_call_threshold,omitempty"`
	MetricsPacketSize                         *int              `json:"metrics_packet_size,omitempty"`
	MetricsPoolSize                           *int              `json:"metrics_pool_size,omitempty"`
	MetricsPort                               *int              `json:"metrics_port,omitempty"`
	MetricsSampleInterval                     *int              `json:"metrics_sample_interval,omitempty"`
	MetricsTimeout                            *int              `json:"metrics_timeout,omitempty"`
	MirrorAvailable                           *bool             `json:"mirror_available,omitempty"`
	MirrorCapacityThreshold                   *int              `json:"mirror_capacity_threshold,omitempty"`
	MirrorMaxCapacity                         *int              `json:"mirror_max_capacity,omitempty"`
	MirrorMaxDelay                            *int              `json:"mirror_max_delay,omitempty"`
	OutboundLocalRequestsWhitelist            []string          `json:"outbound_local_requests_whitelist,omitempty"`
	PagesDomainVerificationEnabled            *bool             `json:"pages_domain_verification_enabled,omitempty"`
	PasswordAuthenticationEnabledForGit       *bool             `json:"password_authentication_enabled_for_git,omitempty"`
	...
	PerformanceBarAllowedGroupPath            *string           `json:"performance_bar_allowed_group_id,omitempty"`
	...
	PollingIntervalMultiplier                 *float64          `json:"polling_interval_multiplier,omitempty,string"`
	...
	PseudonymizerEnabled                      *bool             `json:"psedonymizer_enabled,omitempty"`
	PushEventHooksLimit                       *int              `json:"push_event_hooks_limit,omitempty"`
	PushEventActivitiesLimit                  *int              `json:"push_event_activities_limit,omitempty"`
	...
	ReceiveMaxInputSize                       *int              `json:"receive_max_input_size,omitempty"`
	RepositoryChecksEnabled                   *bool             `json:"repository_checks_enabled,omitempty"`
	RepositorySizeLimit                       *int              `json:"repository_size_limit,omitempty"`
	...
	RestrictedVisibilityLevels                []VisibilityValue `json:"restricted_visibility_levels,omitempty"`
	RsaKeyRestriction                         *int              `json:"rsa_key_restriction,omitempty"`
	SendUserConfirmationEmail                 *bool             `json:"send_user_confirmation_email,omitempty"`
	SessionExpireDelay                        *int              `json:"session_expire_delay,omitempty"`
	SharedRunnersEnabled                      *bool             `json:"shared_runners_enabled,omitempty"`
	SharedRunnersMinutes                      *int              `json:"shared_runners_minutes,omitempty"`
	...
	SlackAppEnabled                           *bool             `json:"slack_app_enabled,omitempty"`
	...
	SnowplowSiteId                            *string           `json:"snowplow_site_id,omitempty"`
	TerminalMaxSessionTime                    *int              `json:"terminal_max_session_time,omitempty"`
	Terms                                     *string           `json:"terms,omitempty"`
	ThrottleAuthenticatedAPIEnabled           *bool             `json:"throttle_authenticated_api_enabled,omitempty"`
	ThrottleAuthenticatedAPIPeriodInSeconds   *int              `json:"throttle_authenticated_api_period_in_seconds,omitempty"`
	ThrottleAuthenticatedAPIRequestsPerPeriod *int              `json:"throttle_authenticated_api_requests_per_period,omitempty"`
	ThrottleAuthenticatedWebEnabled           *bool             `json:"throttle_authenticated_web_enabled,omitempty"`
	ThrottleAuthenticatedWebPeriodInSeconds   *int              `json:"throttle_authenticated_web_period_in_seconds,omitempty"`
	ThrottleAuthenticatedWebRequestsPerPeriod *int              `json:"throttle_authenticated_web_requests_per_period,omitempty"`
	ThrottleUnauthenticatedEnabled            *bool             `json:"throttle_unauthenticated_enabled,omitempty"`
	ThrottleUnauthenticatedPeriodInSeconds    *int              `json:"throttle_unauthenticated_period_in_seconds,omitempty"`
	ThrottleUnauthenticatedRequestsPerPeriod  *int              `json:"throttle_unauthenticated_requests_per_period,omitempty"`
	...
	UniqueIPsLimitPerUser                     *int              `json:"unique_ips_limit_per_user,omitempty"`
	UniqueIPsLimitTimeWindow                  *int              `json:"unique_ips_limit_time_window,omitempty"`
	UsagePingEnabled                          *bool             `json:"usage_ping_enabled,omitempty"`
	UserDefaultExternal                       *bool             `json:"user_default_external,omitempty"`
	UserDefaultInternalRegex                  *string           `json:"user_default_internal_regex,omitempty"`
