...
const (
	...
	// exampleReleaseListRsp provides fixture for Releases tests.
	exampleReleaseListRsp = `[
        {
          "tag_name": "v0.2",
	...
	// exampleReleaseRsp provides fixture for Releases tests.
	exampleReleaseRsp = `{
        "tag_name": "v0.1",
        "description": "description",
        "name": "Awesome app v0.1 alpha",
	...
	// exampleDetailRsp provides fixture for Runners tests.
	exampleDetailRsp = `{
	"active": true,
	"architecture": null,
